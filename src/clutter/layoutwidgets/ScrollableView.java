...
public class ScrollableView extends StatefulWidget<Context> implements ScrollSubscriber {
        ...
        @Override
        public Widget build() {
                return new Row(new Flexible(new Column(new Flexible(new Clip(
                                new ScrollBox(new OverflowBox(content, (Double relContentWidth,
                                ...
                                (scrollController.getRelContentWidth() > 1) ? new ConstrainedBox(
                                                new Row(new Clickable(new Icon(Icons.CARET_LEFT)
                                                                .setFontSize(scrollbarWidth * 3
                                                                                / 4),
                                                                () -> scrollController
                                                                ...
                                                                new Flexible(new Padding(
                                                                                new ScrollBox(new Scrollbar(
                                                                                                ...
                                                                                                scrollX,
                                                                                                0)).vertical(scrollbarWidth
                                                                                                                / 3)),
                                                                new Clickable(new Icon(
                                                                                Icons.CARET_RIGHT)
                                                                                                .setFontSize(scrollbarWidth
                                                                                                                * 3
                                                                                                                / 4),
                                                                                () -> scrollController
                                                                                                .scrollHorizontalPages(
                                                                                                                1),
                                                                                1)).setCrossAxisAlignment(
                                                                                                Alignment.CENTER)
                                                                                                .setDecoration(new Decoration()
                                                                                                                .setColor(Color.lightGray)))
                                                                                                                                .setHeight(scrollbarWidth)
                                                : new NullWidget())).setHorizontalAlignment(
                                                                Alignment.STRETCH),
                                (scrollController.getRelContentHeight() > 1) ? new Column(
                                                new Flexible(new ConstrainedBox(new Column(
                                                                new Clickable(new Icon(
                                                                                Icons.CARET_UP).setFontSize(
                                                                                                scrollbarWidth * 3
                                                                                                                / 4),
                                                                                () -> scrollController
                                                                                                .scrollVerticalPages(
