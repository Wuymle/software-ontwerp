...
public class InputTextTest {
        ...
        public void testSetBorderColor() throws Exception {
                ...
                assertSame(input, returnedInput,
                                "setBorderColor should return this for method chaining");
        ...
        public void testSetValidationFunction() throws Exception {
                ...
                assertEquals(validationFunction,
                                TestHelper.getPrivateField(input, "validationFunction"),
        ...
        public void testIsValid() throws Exception {
                ...
                assertTrue(isValid,
                                "Text should be valid with validationFunction when conditions are met");
