                ...
                new Row(
                            ...
                            columnName = text;
                                ...
                                .setValidationFunction((String name) -> {
                                    return !(context.getDatabase()
                                            .getColumnNames(context.getTable())
                                            .contains(name)
                                            && name != columnName);
                                }),
                        new Padding(
                        ...
                        new CheckBox(context,
                                ...
                                allowBlank -> {
                                    ...
                                    // System.out.println("isValid" + context.getDatabase()
                                    // .getValidDefaultValue(context.getTable(),
                                    // columnName));
                                    // return context.getDatabase().getValidDefaultValue(context.getTable(),
                                    // columnName);
                                    return context.getDatabase().isValidAllowBlankValue(context.getTable(), columnName,
                                            b);
                                }),
                        new Flexible(
                                new ValueCell(
